...
## Release authority
Authority: `scripts/production_learning_roadmap_renewal_check.py` · `BUILD505_PRODUCTION_LEARNING_ROADMAP_RENEWAL.md` · `PRODUCTION_LEARNING_496_504.md` · `FORWARD_BUILD_ROADMAP_506_515.md`. Production is not considered GREEN from source promotion alone.

Retained Build 504 authority: `scripts/service_economics_seasonal_capacity_reliability_trend_continuity_check.py` · `BUILD504_SERVICE_ECONOMICS_SEASONAL_CAPACITY_RELIABILITY_TREND_CONTINUITY.md`.
...
Retained Production Learning & Roadmap Renewal authority: `scripts/production_learning_roadmap_renewal_check.py` · `BUILD505_PRODUCTION_LEARNING_ROADMAP_RENEWAL.md` · `PRODUCTION_LEARNING_496_504.md` · `FORWARD_BUILD_ROADMAP_506_515.md`.

Prior renewal authority: `BUILD495_PRODUCTION_LEARNING_ROADMAP_RENEWAL.md` · `PRODUCTION_LEARNING_486_494.md` · `FORWARD_BUILD_ROADMAP_496_505.md`.
...
3. `BUILD505_PRODUCTION_LEARNING_ROADMAP_RENEWAL.md`
