...
const CACHE='rosie-app-v20260807build245';
const URLS=['/data/build245_ui_health_routes.json',
  '/assets/cache-health-controls.js',
  '/assets/cache-health-controls.js?v=20260807build245',
  '/assets/ui-health-scanner.js',
  '/assets/ui-health-scanner.js?v=20260807build245',
  ...
  '/assets/startup-command-center.js?v=20260807build245',
