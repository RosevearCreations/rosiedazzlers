...
## Build 130 schema/accounting note — 2026-05-06

No required database DDL was added in this pass. The Admin App image change is application-level. Next database targets remain media library records, accounting document attachments, bank reconciliation imports/matches, inventory/COGS posting support, and broader period-lock enforcement.
