...
(function attachAdminAuth(globalScope) {
  ...
  function pageModules(pageKey) {
    switch (String(pageKey || "")) {
      ...
      case "app-operations": case "admin-today": case "admin-booking": case "admin-leads": case "admin-quotes": case "admin-conversions": case "admin-blocks": case "admin-assign": case "admin-customers": case "admin-progress": case "admin-live": case "admin-workflow": case "admin-retention-learning": return ["operations"];
