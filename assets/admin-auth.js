...
(function attachAdminAuth(globalScope) {
  ...
  function pageModules(pageKey) {
    switch (String(pageKey || "")) {
      ...
      case "app-operations": case "admin-today": case "admin-booking": case "admin-leads": case "admin-quotes": case "admin-conversions": case "admin-blocks": case "admin-assign": case "admin-customers": case "admin-progress": case "admin-live": case "admin-workflow": case "admin-retention-learning": case "admin-booking-quote-retention-learning": case "admin-fleet-commercial-learning": return ["operations"];
      case "app-admin": case "admin": case "admin-staff": case "admin-staff-workflow-support-learning": case "admin-inventory-manager": case "admin-inventory-posting": case "admin-catalog": case "admin-maintenance-fleet-owner-approval": case "admin-site-settings": case "admin-water-rules": case "admin-analytics": return ["admin"];
      case "app-it": case "admin-security": case "admin-app": case "admin-docs": case "admin-ui-health": case "admin-support-exceptions": case "admin-reliability-reassessment": case "admin-runtime-health": case "admin-media-health": case "admin-launch-readiness": case "admin-startup-guide": case "admin-production": case "admin-test-centre": case "admin-recovery": case "admin-notifications": case "admin-roadmap-execution": case "admin-sanity": case "admin-bootstrap": return ["it"];
