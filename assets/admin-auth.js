...
(function attachAdminAuth(globalScope) {
  ...
  function pageModules(pageKey) {
    switch (String(pageKey || "")) {
      ...
      case "app-admin": case "admin": case "admin-staff": case "admin-staff-workflow-support-learning": case "admin-service-economics-commercial-capacity-review": case "admin-inventory-manager": case "admin-inventory-posting": case "admin-catalog": case "admin-maintenance-fleet-owner-approval": case "admin-site-settings": case "admin-water-rules": case "admin-analytics": return ["admin"];
