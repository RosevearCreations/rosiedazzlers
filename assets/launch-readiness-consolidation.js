...
function renderRecovery(data){
  ...
  $("#recoveryOut").innerHTML=`
    ...
    <p class="mini"><strong>Source route presence is not artifact proof.</strong> This read-only view does not generate an export, execute a drill or perform a Production restore.</p>
