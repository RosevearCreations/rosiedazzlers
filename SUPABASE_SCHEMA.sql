...
-- 2026-04-28 pass sync: accounting_vendors table plus additive columns for accounting_documents, accounting_bank_reconciliations, and accounting_payroll_payout_reconciliations. Run sql/2026-04-28_accounting_vendor_uploads_and_dependency_rules.sql to apply.

-- 2026-04-28 accounting vendor defaults, document metadata, reconciliation matching, and payroll payout detail.
