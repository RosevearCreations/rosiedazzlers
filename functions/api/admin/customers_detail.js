...
function safeCustomerProfile(profile){
  if(!profile || typeof profile!=="object") return null;
  const { password_hash, password_salt, reset_token, reset_token_hash, verification_token, verification_token_hash, ...safe } = profile;
  return safe;
}
