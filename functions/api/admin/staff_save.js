  ...
  try {
    ...
    if (payload.id) {
      ...
      const patch = {
        ...
        preferred_contact_name: payload.preferred_contact_name,
        ...
        detailer_level: payload.detailer_level,
        permissions_profile: payload.permissions_profile,
        preferred_work_hours: payload.preferred_work_hours,
        pay_schedule: payload.pay_schedule,
        hourly_rate_cents: payload.hourly_rate_cents,
        supervisor_staff_user_id: payload.supervisor_staff_user_id,
        vehicle_info: payload.vehicle_info,
        vehicle_notes: payload.vehicle_notes,
        admin_private_notes: payload.admin_private_notes,
        personal_admin_notes: payload.personal_admin_notes,
        tips_payout_notes: payload.tips_payout_notes,
        notes: payload.notes,
