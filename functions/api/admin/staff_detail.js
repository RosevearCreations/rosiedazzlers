    ...
    return withCors(
      json({
        ...
        staff_user: {
          ...
          pay_schedule: staff.pay_schedule || null,
          hourly_rate_cents: staff.hourly_rate_cents || 0,
          max_hours_per_day: staff.max_hours_per_day || null,
          max_hours_per_week: staff.max_hours_per_week || null,
          payroll_enabled: staff.payroll_enabled !== false,
          payroll_notes: staff.payroll_notes || null,
