...
function normalizePage(page) {
  ...
  return {
    ...
    gallery_image_urls: normalizeStringArray(page?.gallery_image_urls || page?.gallery_images),
    gallery_images: normalizeStringArray(page?.gallery_images || page?.gallery_image_urls),
