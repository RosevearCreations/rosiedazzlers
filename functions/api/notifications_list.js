...
export async function onRequestPost(context) {
  ...
  try {
    ...
    let url = `${env.SUPABASE_URL}/rest/v1/notification_events?select=id,created_at,event_type,channel,booking_id,customer_profile_id,recipient_email,recipient_phone,payload,status,attempt_count,last_error,processed_at,sent_at,next_attempt_at,max_attempts&order=created_at.desc&limit=${limit}`;
