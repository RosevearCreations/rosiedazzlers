// Build 451/461/471/481/492/502 — retained booking/quote learning, measurement lock, controlled execution evidence and outcome interpretation.
import { buildBookingQuoteControlledExperimentExecutionEvidence } from "./booking-quote-controlled-experiment-execution-evidence.js";
import { buildBookingQuoteExperimentOutcomeInterpretation } from "./booking-quote-experiment-outcome-interpretation.js";
...
export function buildBookingFunnelQuotePricingLearning({funnel={},quote_rows=[],source_status={},approval_records={},execution_authorization={},execution_evidence=[],execution_source_available=false,generated_at=null}={}){
  const booking=summarizeBooking(funnel), quotes=summarizeQuotes(quote_rows), learning_signals=deriveSignals(booking,quotes), experiment_readiness=buildExperimentReadiness(booking,quotes), controlled_experiment_framework=buildBookingQuoteControlledExperimentFramework(experiment_readiness), experiment_approval_measurement_lock=buildBookingQuoteExperimentApprovalMeasurementLock(controlled_experiment_framework,approval_records), controlled_experiment_execution_evidence=buildBookingQuoteControlledExperimentExecutionEvidence({measurement_lock:experiment_approval_measurement_lock,execution_authorization,execution_evidence,execution_source_available,generated_at:generated_at||new Date().toISOString()}), controlled_experiment_outcome_interpretation=buildBookingQuoteExperimentOutcomeInterpretation({measurement_lock:experiment_approval_measurement_lock,controlled_execution_evidence:controlled_experiment_execution_evidence,generated_at:generated_at||new Date().toISOString()});
  ...
  return {
    ...
    evidence_status, booking, quotes, learning_signals, experiment_readiness, controlled_experiment_framework, experiment_approval_measurement_lock, controlled_experiment_execution_evidence, controlled_experiment_outcome_interpretation, source_status, release_enrichment_build:461, controlled_experiment_framework_build:471, controlled_experiment_framework_authority:"booking_quote_controlled_experiment_framework", experiment_approval_measurement_lock_build:481, experiment_approval_measurement_lock_authority:"booking_quote_experiment_approval_measurement_lock", controlled_experiment_execution_evidence_build:492, controlled_experiment_execution_evidence_authority:"booking_quote_controlled_experiment_execution_evidence", controlled_experiment_outcome_interpretation_build:502, controlled_experiment_outcome_interpretation_authority:"booking_quote_experiment_outcome_interpretation",
