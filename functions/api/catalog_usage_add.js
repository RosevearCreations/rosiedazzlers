...
export async function onRequestPost({ request, env }){
  try {
    ...
    return withCors(json({ok:true,idempotency_key:idempotencyKey,batch:out.batch||null,lines:out.lines||[],item:out.lines?.[0]||null,accounting,idempotent_replay:out.idempotent_replay===true}));
