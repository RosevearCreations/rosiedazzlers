...
function sanitizePayload(payload){if(!payload||typeof payload!=='object'||Array.isArray(payload))return {};const out={};for(const[k,v]of Object.entries(payload).slice(0,20)){const key=String(k).slice(0,80);if(v==null)out[key]=null;else if(['string','number','boolean'].includes(typeof v))out[key]=typeof v==='string'?v.slice(0,500):v;}return out;}
