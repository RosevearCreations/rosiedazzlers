...
export async function onRequestGet(context) {
  ...
  try {
    ...
    const [updatesResult, mediaResult, signoffsRes, checklistRes, usageRes, eventsRes, incidentsRes] = await Promise.all([
      fetchAdaptive(env, headers, "job_updates", bookingId,
        "id,created_at,created_by,note,visibility,thread_status,stage,source_channel,review_status,customer_action_required,customer_visible_at",
        "id,created_at,created_by,note,visibility"),
      fetchAdaptive(env, headers, "job_media", bookingId,
        "id,created_at,created_by,kind,caption,media_url,visibility,thread_status,stage,source_channel,review_status,customer_action_required,customer_visible_at,storage_bucket,storage_path,content_type,file_size_bytes",
