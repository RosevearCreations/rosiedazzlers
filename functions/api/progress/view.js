export async function onRequestGet(context) {
  ...
  try {
    ...
    const [updatesRes, mediaRes, signoffsRes, commentsRes, prefRes] = await Promise.all([
      ...
      fetch(`${env.SUPABASE_URL}/rest/v1/progress_comments?select=id,booking_id,parent_type,parent_id,author_type,author_name,author_email,message,created_at&booking_id=eq.${bookingId}&order=created_at.asc`, { headers }),
