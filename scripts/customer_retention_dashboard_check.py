#!/usr/bin/env python3
"""Focused source proof for the read-only customer retention dashboard."""
...
def main() -> None:
    ...
    for needle, label in [
        ...
        ("crm_queue:false", "CRM queue excluded"),
    ...
    for needle, label in [
        ('data-build359="customer-retention-dashboard"', "retention UI marker"),
    ...
    print("GREEN: customer retention dashboard focused source proof passed.")
