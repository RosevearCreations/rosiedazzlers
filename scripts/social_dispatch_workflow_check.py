#!/usr/bin/env python3
"""Verify Build 157 social queue and publishing bridge files and markers exist."""
...
MARKERS = {
    "admin-progress/index.html": ["socialDraftEnabled", "socialAutoPublishEnabled", "socialPostsList", "/api/admin/social_post_create", "/api/admin/social_post_dispatch"],
    "admin-social/index.html": ["Social Queue", "Publish/API", "data-copy-text", "/api/admin/social_posts_list", "/api/admin/social_post_dispatch"],
...
def main() -> int:
    ...
    print("Build 157 social dispatch workflow check passed.")
    return 0
