...
require(queue,["BUILD447_RECOVERY_ARTIFACT_DRILL_EVIDENCE_REVIEW.md","**Build 452 — Staff Workflow, Support & Mobile Efficiency Learning** is the active bounded release.","**Build 453 — Service Economics, Capacity & Pricing Review** is next"],"release queue")
...
require(readme,["BUILD447_RECOVERY_ARTIFACT_DRILL_EVIDENCE_REVIEW.md","recovery_artifact_drill_evidence_review_check.py","Current source direction: **Build 452 — Staff Workflow, Support & Mobile Efficiency Learning**."],"README")
