...
require(queue,["BUILD447_RECOVERY_ARTIFACT_DRILL_EVIDENCE_REVIEW.md","**Build 451 — Booking Funnel, Quote & Pricing Learning** is the active bounded release.","**Build 452 — Staff Workflow, Support & Mobile Efficiency Learning** is next"],"release queue")
...
require(readme,["BUILD447_RECOVERY_ARTIFACT_DRILL_EVIDENCE_REVIEW.md","recovery_artifact_drill_evidence_review_check.py","Current source direction: **Build 451 — Booking Funnel, Quote & Pricing Learning**."],"README")
