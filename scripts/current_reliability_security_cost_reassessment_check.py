...
workflow = read(".github/workflows/current-reliability-security-cost-reassessment-authority.yml")
...
require(source_gate, ["python scripts/current_reliability_security_cost_reassessment_check.py"], "Development source gate")
require(prod_workflow, ["python scripts/current_reliability_security_cost_reassessment_check.py"], "Production business workflow")
require(prod_check, [
