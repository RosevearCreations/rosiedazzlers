...
def inline_script_check(rel):
    body = text(rel)
    scripts = re.findall(r"<script([^>]*)>([\s\S]*?)</script>", body, flags=re.I)
    for i, (attrs, script) in enumerate(scripts, start=1):
        # JSON-LD is data, not JavaScript. Parsing it through node --check creates a false failure.
...
need(
    ...
    "EDITABLE_SELECTOR", "MutationObserver", "aria-modal", "ⓘ Page help",
    "What this is", "What it changes", "Why Rosie needs it", "Where the value comes from",
    "How to obtain it", "Prerequisites / permissions", "Where Rosie stores it",
    "Callback / redirect setup", "How to test it", "Troubleshooting", "Official provider resources",
    "/admin-integrations.html",
)
need(
    "assets/contextual-help-catalog.js",
    'version: "274.1"', "defaultPage", '"admin-integrations"', '"admin-site-settings"', "settingJson", "security:",
)
...
need(
    ...
    'version: "274.2"',
    "SUPABASE_SERVICE_ROLE_KEY", "ROSIE_PUBLIC_ASSETS_BUCKET", "STRIPE_WEBHOOK_SECRET", "PAYPAL_WEBHOOK_ID",
    "FACEBOOK_PAGE_ACCESS_TOKEN", "INSTAGRAM_ACCESS_TOKEN", "TIKTOK_ACCESS_TOKEN", "LINKEDIN_ACCESS_TOKEN",
    "YOUTUBE_ACCESS_TOKEN", "GOOGLE_OAUTH_ACCESS_TOKEN", "GOOGLE_BUSINESS_PROFILE_LOCATION_NAME",
    "google_search_console", "google_maps", "github", "YouTube Data API v3", "Google Auth Platform",
    "redirect_uri_mismatch", "setup:", "Cloudflare Pages encrypted secret",
)
...
need(
    "assets/admin-page-init.js", "loadContextualHelp", "/assets/contextual-help-catalog.js", "/assets/contextual-help.js",
    "protected page startup will continue",
)
need(
    "assets/admin-menu.js", "ensureContextualHelp", "/assets/contextual-help-catalog.js", "/assets/contextual-help.js",
    "menu rendering will continue",
)
need(
    "assets/admin-shell.js", "ensureContextualHelp", "/assets/contextual-help-catalog.js", "/assets/contextual-help.js",
    "protected page startup will continue",
)

# Protected HTML coverage: legacy AdminShell is now an intentional compatibility bridge too.
protected_markers = ["/assets/admin-auth.js", "AdminAuth.guardPage", "AdminAuth.requireAuth", "AdminShell.boot"]
bridges = ["/assets/admin-page-init.js", "/assets/admin-menu.js", "/assets/admin-shell.js", "/assets/contextual-help.js"]
...
need(
    ...
    'catalogue_version: "274.1"', "SUPABASE_URL", "SUPABASE_SERVICE_ROLE_KEY", "ROSIE_PUBLIC_ASSETS_BUCKET",
    "PUBLIC_ASSETS_BUCKET", "R2_PUBLIC_ASSETS_BUCKET", "ASSETS_BUCKET", "STRIPE_SECRET_KEY", "STRIPE_WEBHOOK_SECRET",
    "STRIPE_WEBHOOK_SECRET_QUOTES", "PAYPAL_CLIENT_ID", "PAYPAL_CLIENT_SECRET", "PAYPAL_WEBHOOK_ID", "PAYPAL_API_BASE",
    "NOTIFICATIONS_EMAIL_WEBHOOK_URL", "RECOVERY_EMAIL_WEBHOOK_URL", "NOTIFICATIONS_SMS_WEBHOOK_URL", "RECOVERY_SMS_WEBHOOK_URL",
    "NOTIFICATIONS_PUSH_WEBHOOK_URL", "NOTIFICATIONS_PUSH_PROVIDER_AUTH_TOKEN", "GA4_MEASUREMENT_ID",
    "FACEBOOK_PAGE_ACCESS_TOKEN", "YOUTUBE_ACCESS_TOKEN", "GOOGLE_BUSINESS_PROFILE_LOCATION_NAME",
    "Google Search Console", "Google Maps Platform", "GitHub", "no_secrets_returned: true",
)
...
need(
    "admin-integrations.html", "I.T. connections", "Core application services", "Consent-first website measurement",
    "Social, video and local publishing", "Prepared and control-plane integrations", "Safe connection test standard",
    "/api/admin/integration_status", "window.AdminPageInit.init", 'data-build274="it-help-foundation"',
    "/assets/it-external-help-catalog.js", "data-it-help-key", "it-help-button", "openITHelp",
    "How to obtain and configure", "Use the circled",
)
...
need(
    "assets/pricing-catalog-client.js", "pricing-catalog-client-legacy.js", "ROSIE_PUBLIC_REQUIREMENTS",
    "Rosie brings standard detailing water and power", 'import("./booking-quick-start-v274.js")', "applyRosieOperatingRules",
)
need(
    "assets/booking-quick-start-v274.js", "mobile-first Quick Book", "What does your vehicle need?",
    "Optional vehicle details", "Next available days", "booking_quick_need_pick", "photo_quote", "Saved Garage vehicles",
    "Rosie-supplied water/power", "premium_wash", "interior_detail", "complete_detail", "exterior_detail",
)
need(
    "book.html", 'data-step="1"', 'id="packageCards"', 'id="conditionRecommendBtn"', 'id="ack_power_water"',
    'id="veh_year"', 'id="veh_make"', 'id="veh_model"', 'id="vehicle_size"',
)
forbid("assets/booking-quick-start-v274.js", "/api/checkout", "STRIPE_SECRET_KEY", "PAYPAL_CLIENT_SECRET")

# Standard mobile-detail utilities are a canonical runtime rule on both server and browser.
need(
    "functions/api/_lib/pricing-catalog.js", "ROSIE_PUBLIC_REQUIREMENTS", "ROSIE_ACCESS_RULE",
    "Rosie brings standard detailing water and power", "stale App Management JSON",
)
forbid("assets/pricing-catalog-client.js", "Customer provides power and water", "Customer supplies power and water")

# Public trust and service-merchandising authority must remain crawlable and aligned with the booking model.
one_h1("index.html")
need(
    "index.html", "Mobile Auto Detailing &amp; Interior/Exterior Restoration", "Rosie brings standard water + power",
    "Rosie brings standard detailing water and power", "data-review-proof-mount", "/book?estimate=photos",
    "/carpet-shampoo", "/headlight-restoration",
)
forbid(
    "index.html", "Sample customer-style reviews", "Sample Rosie Dazzlers customer reviews", "Customer provides power + water",
    "If power/water are not available", "Melissa R.", "Jason K.", "Amanda P.", "Trevor M.", "Rachel D.",
)

one_h1("headlight-restoration/index.html")
need(
    "headlight-restoration/index.html", "From $99 per pair", "From $129 per pair", "From $169+ per pair",
    "UV protection", "Rosie brings standard detailing water and power",
    "/book?estimate=photos&amp;addon=headlight_restoration_addon", "cracks, internal haze or moisture",
)
forbid("headlight-restoration/index.html", "warranty", "guaranteed", "Customer provides power", "Customer supplies power")

one_h1("carpet-shampoo/index.html")
need(
    "carpet-shampoo/index.html", "Small $99 · Mid $129 · Oversize $159", "From $129–$159+",
    "From $299+ / inspection quote", "under-carpet", "seat/trim", "Rosie brings standard detailing water and power",
    "/book?estimate=photos&amp;addon=carpet_shampoo", "biological growth", "corrosion",
)
forbid("carpet-shampoo/index.html", "mold remediation", "mould remediation", "Customer provides power", "Customer supplies power")

# JavaScript syntax and executable registry behavior.
for rel in [
    "functions/api/_lib/integration-registry.js", "functions/api/_lib/pricing-catalog.js",
    "assets/contextual-help-catalog.js", "assets/contextual-help.js", "assets/it-external-help-catalog.js",
    "assets/admin-page-init.js", "assets/admin-menu.js", "assets/admin-shell.js",
    "assets/pricing-catalog-client.js", "assets/pricing-catalog-client-legacy.js", "assets/booking-quick-start-v274.js",
]:
    node_check(rel)
...
need(".github/workflows/build274-source-gate.yml", "Build 274 Source Gate", "python scripts/build274_release_check.py", "python scripts/release_check.py")
...
print(" - AdminPageInit, AdminMenu and legacy AdminShell protected screens all have a fail-open contextual-help bridge")
...
print(" - Build 274 feature source gate, Development workflow and living authorities are synchronized")
