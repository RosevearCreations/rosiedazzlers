...
CHECKS = [
    ...
    "scripts/release_check_build263.py",
    "scripts/release_check_build264.py",
    "scripts/release_check_build265.py",
    "scripts/release_check_build266.py",
    "scripts/release_check_build267.py",
