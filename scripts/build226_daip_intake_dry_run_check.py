...
assert any(v in sw for v in ('rosie-app-v20260708build226','rosie-app-v20260712build228','rosie-app-v20260712build229','rosie-app-v20260713build230','rosie-app-v20260714build231','rosie-app-v20260726build236'))
