...
- expose only aggregate job-handoff counts; no customer names, addresses, messages or booking identifiers are returned;
...
Never call a Rosie Dazzlers source release GREEN from source changes alone. Source/Production GREEN may coexist with a controlled-pilot HOLD until authorized real-world evidence is actually observed. Database migrations and provider/business mutations remain separate explicit acceptance boundaries.
